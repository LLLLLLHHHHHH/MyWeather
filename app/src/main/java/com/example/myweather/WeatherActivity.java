...
public class WeatherActivity extends AppCompatActivity {
    ...
    protected void onStart() {
        ...
        search_input.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextSubmit(String query) {
                //待解决：解决搜索id不存在时候的问题
                if(query.length()!=6){
                    Toast.makeText(WeatherActivity.this, "请输入六位城市编码", Toast.LENGTH_SHORT).show();
                }else{
                    //更新数据
    ...
    public String requestIp(){
        String ipUrl = "https://restapi.amap.com/v3/ip?key=94d9e529b02645e4c520ff7bef49291b";
    ...
    public void requestWeather(final String weatherId){
        ...
        String weatherUrl = "https://restapi.amap.com/v3/weather/weatherInfo?key=94d9e529b02645e4c520ff7bef49291b&city=" + weatherId + "&extensions=all&output=JSON";
...
//                            Log.d(TAG, "run: " + responseText);
    ...
    public void requestNowWeather(final String weatherId){
        String weatherUrl = "https://restapi.amap.com/v3/weather/weatherInfo?key=94d9e529b02645e4c520ff7bef49291b&city=" + weatherId + "&output=JSON";
        HttpUtil.sendOkHttpRequest(weatherUrl, new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                final String responseText = response.body().string();
